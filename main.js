...
class AdventureSheetComponent {
    ...
    addItem(event) {
        this.player.items.push(new src_app_models_player__WEBPACK_IMPORTED_MODULE_1__["Item"]());
    }
